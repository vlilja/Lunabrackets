...
export default class Bracket extends React.Component {
  ...
  componentWillMount() {
    var tournamentType = this.props.tournament.type;
    var id = this.props.tournament.id;

    this.props.dispatch(fetchParticipants(id)); 

    switch (tournamentType) {
      case constants.tournamentTypes.single:
        this.props.dispatch(getSingleEliminationMatches(id));
        break;
      case constants.tournamentTypes.doubleEliminationC:
        this.props.dispatch(getDoubleEliminationMatches(id));
      default:
        //Fetch nothing
        break;
    }
